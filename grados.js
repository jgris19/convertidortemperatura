...
//Función para tomar los valores de las temperaturas ingresadas por el usuario y mostrar los resultados
...
//Esta función limpia los datos ingresados y los resultados
function limpiarCampos() {
    document.getElementById('temperaturas').value = '';
